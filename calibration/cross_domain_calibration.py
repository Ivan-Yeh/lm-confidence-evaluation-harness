...
if __name__ == "__main__":
    ...
    ling_train_path = get_latest_leaf_node(f"{common_dir}/results/{args.train}/{task}/{args.model}/")
    tp_train_path = get_latest_leaf_node(f"{common_dir}/results/{args.train}/{task}/{args.model}/")
    su_train_path = get_latest_leaf_node(f"{common_dir}/results/{args.train}/{task}/{args.model}/")

    ling_test_path = get_latest_leaf_node(f"{common_dir}/results/{args.test}/{task}/{args.model}/")
    tp_test_path = get_latest_leaf_node(f"{common_dir}/results/{args.test}/{task}/{args.model}/")
    su_test_path = get_latest_leaf_node(f"{common_dir}/results/{args.test}/{task}/{args.model}/")
    ...
    save_dir = f"{common_dir}/cross_domain_calibration/{args.train}--{args.test}/{args.model}/"
