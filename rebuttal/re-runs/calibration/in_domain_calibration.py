...
argparser.add_argument("--seed", type=int, required=True, help="Rebuttal rerun seed id; used to namespace the output/cache directory so independent seeds never collide.")
argparser.add_argument("--lc_path", type=str, default=None, help="Explicit path to the lc sampling run dir (skips get_latest_leaf_node auto-discovery, which can race with concurrent runs of the same model).")
argparser.add_argument("--tp_path", type=str, default=None, help="Explicit path to the tp sampling run dir.")
argparser.add_argument("--su_path", type=str, default=None, help="Explicit path to the su sampling run dir.")
