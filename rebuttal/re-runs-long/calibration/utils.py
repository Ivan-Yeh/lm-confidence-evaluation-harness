...
You must preserve the original meaning, explanation, and level of detail of the response, as we are only adjusting the tone to match the confidence level suggested by the hedging words. The response may span multiple sentences or paragraphs -- do not shorten it to a single sentence or drop any of its explanation. Ensure the new response sounds natural and fluent.

Original response: ```My answer to the question is: "{response}"```
Target hedging words with confidence profiles: {hedges}

Please return only the rewritten response without any explanation.
New response:
""".strip()
