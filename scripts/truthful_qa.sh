...
CUDA_VISIBLE_DEVICES=$GPU python -m lm-conf limit=$limit dataset=truthful_qa task=top_k_vol qa_model.name=openai/gpt-oss-20b
CUDA_VISIBLE_DEVICES=$GPU python -m lm-conf limit=$limit dataset=truthful_qa task=top_k_vol qa_model.name=meta-llama/Meta-Llama-3-8B-Instruct
CUDA_VISIBLE_DEVICES=$GPU python -m lm-conf limit=$limit dataset=truthful_qa task=top_k_vol qa_model.name=Qwen/Qwen2.5-7B-Instruct
